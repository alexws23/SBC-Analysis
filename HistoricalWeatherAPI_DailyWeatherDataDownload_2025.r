...
setwd("R:/SBC_analyses/For_Linux_Server")
getwd
...
get_weather_data <- function(lat, lon, start_date, end_date, variables = c("precipitation_sum", "rain_sum", "snowfall_sum", "temperature_2m_max", "temperature_2m_min")) {
...
# --- Parameters ---
years <- 2025
daily_vars <- c("precipitation_sum", "rain_sum", "snowfall_sum", "temperature_2m_max", "temperature_2m_min")
output_dir <- "R:/SBC_analyses/For_Linux_Server/2025_outputs"
